...
impl KnowledgeAwareGameState {
    ...
    fn apply_clue(
        ...
        // as `current` (simple_prompt/finesse Case 2) see the receiver's perspective.
        self.table_state.player_on_turn_index = receiver;
        ...
        for target in (0..num_players).filter(|&t| t != receiver) {
            self.table_state.player_on_turn_index = target;
        ...
        self.table_state.player_on_turn_index = giver;
    }
    ...
    pub fn synthesize_draw(&mut self, player_index: usize) {
