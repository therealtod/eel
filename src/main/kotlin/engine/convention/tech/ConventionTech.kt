...
interface ConventionTech {
    ...
    fun getGeneratedKnowledge(playAction: PlayAction, playerPOV: GameFromPlayerPOV): TeamKnowledge
    fun getGeneratedKnowledge(discardAction: DiscardAction, playerPOV: GameFromPlayerPOV): TeamKnowledge
